...
<body>
    <div class="container">
        <div class="header">
            <h1>📋 CRF Assigned to Vendor HOU</h1>
        </div>
        
        <div class="content">
            <p>Dear {{ $assignedUser->name }},</p>
            
            <p>A Customer Request Form has been assigned to you for action.</p>
            ...
            <p>Please take action on this CRF at your earliest convenience.</p>
