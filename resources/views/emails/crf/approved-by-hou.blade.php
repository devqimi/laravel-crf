...
<body>
    <div class="container">
        <div class="header">
            <h1>📋 CRF Approved by HOU</h1>
        </div>
        
        <div class="content">

            @if($crf->category->cname === 'Hardware Request/Relocation')
                <p>Dear TP,</p>
                <p>A CRF for Hardware Request/Relocation has been approved by HOU and requires your approval.</p>
            @else
                <p>Dear IT HOU,</p>
